...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> Update Link
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('index.php/admin/partner_controller/partner_link_edit') ?>"
                          method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="link">Link</label>
                            <input type="url" id="link" class="form-control" required="reqquired"
                                   value="<?php echo $partner->link ?>" name="link"
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?php echo base_url('web/admin/upload/' . $partner->file) ?>"
                                 alt="<?php echo $partner->file; ?>" style="width:100px; height:100px;"/>
                            <input type="hidden" id="id" name="id" value="<?php echo $partner->id; ?>"/>
                        </div>

                        <div class="form-group">
                            <label for="file">Upload logo</label>
                            <input type="file" id="file" name="file" placeholder="upload logo"
                                   class="form-control"/>
                        </div>
                        <div class="form-group">
