        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active" style="text-transform:capitalize;">
                            <i class="fa fa-file"></i> Add <?php echo $page->name; ?>'s page
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo base_url('index.php/admin/PageController/page_add') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="redactor" cols="30" rows="10"
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo base_url('index.php/admin/PageController/page/' . $page->id) ?>"
