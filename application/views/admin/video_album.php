            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> Video Albums
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        <button class="btn btn-danger btn-sm" ng-click="add_enable=true"><i class="fa fa-plus"></i> Add
                        </button>
                    </div>
                </div>
                <div class="col-md-1">
                    <div class="form-group">
                        <a href="<?php echo base_url('index.php/admin/videocontroller/add_video_view') ?>"
                           class="btn btn-sm btn-danger"><i class="fa fa-plus"></i> Add Videos</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped table-responsive">
                        ...
                        <tr ng-repeat="item in data">
                            ...
                            <td>
                                <a href="<?php echo base_url('index.php/admin/videocontroller/video_list') ?>/{{item.id}}">{{item.count}}</a>
                            </td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-success" ng-show="edit_enable"
                                        ng-click="update(item.id,item.name)"><i class="fa fa-check-square-o"></i> Update
                                </button>
...
<script>
    ...
    app.controller('MyController', function ($scope, $http) {
        ...
        $scope.refresh = function () {
            $http.get('<?php echo base_url('index.php/admin/videocontroller/get_albums')?>').success(function (data) {
                $scope.data = data;
            }).error(function (data) {
                alert(data);
            });
        ...
        $scope.add = function () {
            ...
            $http.post('<?php echo base_url('index.php/admin/videocontroller/add_album')?>', $scope.data).success(function (data) {
                $scope.add_enable = false;
                $scope.name = '';
                $scope.refresh();
            }).error(function (data) {
        ...
        $scope.update = function (id, name) {
            ...
            $http.post("<?php echo base_url('index.php/admin/videocontroller/album_update')?>", $scope.data).success(function (data) {
                $scope.refresh();
            }).error(function (data) {
                alert(data);
            })
        ...
        $scope.delete = function (id) {
            ...
            if (confirm('this album will be deleted!!!')) {
                $scope.data = {'id': id};
                $http.post('<?php echo base_url('index.php/admin/videocontroller/album_delete')?>', $scope.data).success(function (data) {
                    $scope.refresh();
                }).error(function (data) {
                    alert(data);
                });
