            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> News Update
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <a href="<?php echo base_url('index.php/admin/NewsController/news_add_view') ?>"
...
<script>
    ...
    app.controller('MyController', function ($scope, $http) {
        ...
        $http.get('<?php echo base_url('index.php/admin/NewsController/news')?>').success(function (data) {
            $scope.data = data;
        }).error(function (data) {
            alert(data);
        });
        ...
        $scope.delete = function (id) {
            if (confirm('Do you really want to delete? ')) {
                $http.post('<?php echo base_url('index.php/admin/NewsController/news_delete')?>/' + id).success(function (data) {
                    $scope.refresh();
                }).error(function (data) {
                    alert(data);
                })
