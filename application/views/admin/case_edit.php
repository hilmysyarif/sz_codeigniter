...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('index.php/admin/case_controller/case_edit') ?>" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="state" value="<?php echo $data->state; ?>" class="form-control"
                                   placeholder="state" name="state" required="required"/>
                        </div>

                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" id="city" value="<?php echo $data->city; ?>" class="form-control"
                                   placeholder="city" name="city" required="required"/>
                        </div>

                        <div class="form-group">
                            <label for="address">Address</label>
                            <textarea name="address" id="address" cols="30" class="form-control" rows="3"
                                      required="required"><?php echo $data->address; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea name="description" class="form-control" id="description" cols="30" rows="5"
                                      required="required"><?php echo $data->description; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label for="Image">Image</label>
                            <br/>
                            <img src="<?php echo base_url('web/admin/upload/' . $data->file) ?>"
                                 alt="<?php echo $data->file; ?>" class="img-thumbnail img-responsive"/>
                        </div>
