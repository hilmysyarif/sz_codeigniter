...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url('index.php/admin/LoginController/update') ?>" method="post">
                        <div class="form-group">
                            <label for="old">Old Password</label>
                            <input type="password" class="form-control" name="old" required="required"  placeholder="Old Password"/>
                        </div>

                        <div class="form-group">
                            <label for="old">New Password</label>
                            <input type="password" class="form-control" name="new" required="required" placeholder="New Password"/>
                        </div>

                        <div class="form-group">
                            <label for="old">Confirm Password</label>
                            <input type="password" class="form-control" name="confirm" required="required" placeholder="Confirm Password"/>
                        </div>

                        <input type="submit" name="submit" value="save" class="btn btn-sm btn-success" />
                        <a href="<?php echo base_url('index.php/admin/home')?>" class="btn btn-sm btn-danger">Cancel</a>
                    </form>
                </div>
            </div>
