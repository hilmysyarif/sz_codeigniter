            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-file"></i> <?php echo $partner->name; ?>'s link list
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-responsive table-striped">
                        ...
                        <?php foreach ($partner_data as $row) {
                            ?>
                            <tr>
                                <td><?php echo $row->id; ?></td>
                                <td><a href="<?php echo $row->link; ?>" target="_blank">
                                        <img src="<?php echo base_url('web/admin/upload/' . $row->file) ?>"
                                             alt="<?php echo $row->file; ?>" style="height:100px; width:100px;"/>
                                    </a></td>
                                <td>
                                    <a href="<?php echo base_url('index.php/admin/partner_controller/partner_link_edit_view/' . $row->id) ?>"
                                       class="btn btn-success btn-sm"><i class="fa fa-check-square-o"></i> Edit</a>
                                    <a href="<?php echo base_url('index.php/admin/partner_controller/partner_link_delete/' . $row->id) ?>"
                                       class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Delete</a>
                                </td>
                            </tr>
                        <?php
                        }?>
