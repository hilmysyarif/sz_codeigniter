    ...
    <div class="row category">
        <div class="col-md-12">
            <ul class="list-inline">
                ...
                <li>
                    <div class="heading btn_about" ng-click="special_case()">
                       Special Case
                    </div>
                </li>
            </ul>
    ...
    <section class="gallery">
        <div class="row" ng-show="enable_show" >
            ...
            <div class="col-md-3 col-sm-3 col-xs-6 nopad" ng-repeat="item in photos" style="position:relative;">
                <div class="thumbnail">
                    <a class="fancybox" rel="group" href="<?php echo base_url('web/admin/upload') ?>/{{ item.file }}    "><img class="grow" src="<?php echo base_url('web/admin/upload') ?>/{{ item.file }}" style="height:217px;" alt="img12"/></a>
                </div>
            </div>

        </div>

        <div class="row" ng-hide="enable_show" >

            <div class="col-md-3 col-sm-3 col-xs-6 nopad" ng-repeat="item in case" style="position:relative;">
                <div class="thumbnail">
                    <a href="<?php echo base_url('index.php/front/front_controller/special_case_content') ?>/{{ item.id }}"><img class="grow" src="<?php echo base_url('web/admin/upload') ?>/{{ item.file }}" style="height: 150px;" alt="img12"/></a>
                </div>
            </div>
...
<script>
    ...
    app.controller('MyController', function ($scope, $http) {
        ...
        $http.post('<?php echo base_url('index.php/front/front_controller/gallery_album')?>').success(function(data){
        ...
        $scope.album_photos=function(id){
            $http.post('<?php echo base_url('index.php/front/front_controller/album_photos/')?>/'+id).success(function(data){
