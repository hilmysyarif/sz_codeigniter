        ...
        <div class="col-md-12">
            ...
            <ul class="list-inline">
                <li ng-repeat="item in category">
                    <div class="heading btn_about" ng-click="program_sub_cat(item.id)">
                        {{ item.name }}
                    </div>
                </li>
            </ul>
        ...
        <div class="col-md-12">
            ...
            <ul class="list-inline">
                <li ng-repeat="item in sub_category">
                    <div class="heading btn_about" ng-click="program_category_content($index)">
                        {{ item.Title }}
                    </div>
                </li>
            </ul>
...
<script>
    ...
    app.controller('MyController', function ($scope, $http) {
        ...
        $http.post('<?php echo base_url('index.php/front/front_controller/program_category')?>').success(function (data) {
        ...
        $scope.program_sub_cat = function (id) {
            $http.post('<?php echo base_url('index.php/front/front_controller/program_sub_cat')?>/' + id).success(function (data) {
        ...
        $scope.program_category_content = function (index) {
